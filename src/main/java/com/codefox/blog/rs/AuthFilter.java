...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res,
        ...
        System.out.println("AuthFilter.doFilter() uri === "+hreq.getRequestURI());
        System.out.println("AuthFilter.doFilter() post = "+hreq.getMethod());
        if (hreq.getRequestURI().contains("/techspace/user/register") && hreq.getMethod().equals("POST")) {
            System.out.println("AuthFilter.doFilter() register user");
